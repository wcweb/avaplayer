package com.longtailvideo.jwplayer.model {
	...
	public dynamic class PlayerConfig extends EventDispatcher {
		...
		public function get playlistfile() : String {
		...
		public function get author() : String {
			return playlistItem('author');
		}

		/** Publish date of the media file. **/
		public function get date() : String {
			return playlistItem('date');
		}
		...
		public function set backcolor(x : Color) : void {
			_backcolor = x;
		}

		/** Color of all icons and texts in the controlbar and playlist. **/
		public function get frontcolor() : Color {
			return _frontcolor;
		}

		public function set frontcolor(x : Color) : void {
			_frontcolor = x;
		}
		...
		public function set lightcolor(x : Color) : void {
			_lightcolor = x;
		}

		/** Background color of the display. **/
		public function get screencolor() : Color {
			return _screencolor;
		}

		public function set screencolor(x : Color) : void {
			_screencolor = x;
		}
		...
		public function set icons(x : Boolean) : void {
			_icons = x;
		}
		...
		public function get playlist() : String {
			if (_pluginConfig['playlist'] && _pluginConfig['playlist'].hasOwnProperty('position'))
				return (_pluginConfig['playlist'] && _pluginConfig['playlist']['position']).toString();
		...
		public function set bandwidth(x : Number) : void {
			_bandwidth = x;
		}
		...
		public function set bufferlength(x : Number) : void {
			_bufferlength = x;
		}

		/** Set this to true to print the title of a video in the display. @default true **/
		public function get displaytitle() : Boolean {
			return _displaytitle;
		}

		public function set displaytitle(x : Boolean) : void {
			_displaytitle = x;
		}
		...
		public function set item(x : Number) : void {
			_item = x;
		}
		...
		public function set linktarget(x : String) : void {
			_linktarget = x;
		}
		...
		public function set repeat(x : String) : void {
			_repeat = x.toLowerCase();
		}
		...
		public function set shuffle(x : Boolean) : void {
			_shuffle = x;
		}
		...
		public function get playerready() : String {
			return _playerready;
		}

		public function set playerready(x : String) : void {
			_playerready = x;
		}
	}
}
