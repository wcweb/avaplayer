package com.longtailvideo.jwplayer.view.components {
	...
	public class ControlbarComponentV4 extends CoreComponent implements IControlbarComponent {
		...
		public function ControlbarComponentV4(player : IPlayer) {
			...
			BUTTONS = {playButton:ViewEvent.JWPLAYER_VIEW_PLAY, pauseButton:ViewEvent.JWPLAYER_VIEW_PAUSE, stopButton:ViewEvent.JWPLAYER_VIEW_STOP, prevButton:ViewEvent.JWPLAYER_VIEW_PREV, nextButton:ViewEvent.JWPLAYER_VIEW_NEXT, fullscreenButton:ViewEvent.JWPLAYER_VIEW_FULLSCREEN, normalscreenButton:ViewEvent.JWPLAYER_VIEW_FULLSCREEN, muteButton:ViewEvent.JWPLAYER_VIEW_MUTE, unmuteButton:ViewEvent.JWPLAYER_VIEW_MUTE};
		...
		private function upHandler(evt : MouseEvent) : void {
			...
			pct = (pct < 10 && sliderType == 'volumeSlider') ? 0 : pct;
